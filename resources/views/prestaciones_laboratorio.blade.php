@extends('layouts.app')
@section('titulo') Prestaciones Laboratorio @endsection
@section('content')
<header class="content__title">
    <h1>PRESTACIONES y valores IMAGEONOLOGÍA</h1>
    <small>Acá, encuentras las prestaciones de Laboratorio, Sangre, Pcr, Muestras, con sus respectivos precios, también puedes descargar el pdf con los valores desde <a href="https://www.clinicabupasantiago.cl/clinica_santiago/site/artic/20190311/asocfile/20190311171620/arancel_2019_servicios_laboratorio.pdf" target="_blank">ACÁ</a></small>
...
<script>
    $(function () {
      var table = $('.data-table').DataTable({
          ...
          ajax: "{{ route('PRESTACIONES LABORATORIO') }}",
          columns: [
              {data: 'id'},
              {data: 'cod_sap'},
              {data: 'cod_imed'},
